...
count_data <- read.csv("count_data.csv", header = TRUE, sep = ',')
presc <- read.csv("presc_clean.csv", header = TRUE, sep = ',')
prog <- read.csv("prog_clean.csv", header = TRUE, sep = ',')
demo <- read.csv("demo_clean.csv", header = TRUE, sep = ',')
